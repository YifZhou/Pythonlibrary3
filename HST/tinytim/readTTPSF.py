...
def readTTPSF(fn, DIR='.', shifts=(0, 0), sup=9, downsamp=True):
    """read PSFs generated by TinyTim

    :param fn: PSF fits file name
    :param DIR: directories that save the PSF fits files
    :param shifts: (default:y=0, x=0) how much in pixel the PSF need to be shifted
    :param sup: super sample rate of the read in PSF
    :param downsamp: (default True) whether downsampling the PSFs to
    WFC3 detector sample rate
    :returns: WFC3 PSF
    :rtype: numpy array
